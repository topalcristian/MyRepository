import java.lang.IllegalArgumentException;
		...
		public class modifyBA{
			
			private double balance;

			public modifyBA(double amount) throws IllegalArgumentException{
				balance = amount;
			...
			public void withdraw(double amount) throws IllegalArgumentException{
				...
				if(amount>balance){
					throw new IllegalArgumentException("You withdraw more money than you have on your bankaccount!");
				}
			...
			public static void main(String[] args){
				...
				try{
					// balance exception
					modifyBA account1 = new modifyBA(-200);
					account1.deposit(20);
