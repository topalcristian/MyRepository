...
# Out of some reason I had to change the input to raw_input
...
# we had to change debug_J[0][0], since J is a variable not an array
print('Cost at (fixed) debugging parameters (w/ lambda = 10): ', debug_J[0], '(this value should be about 0.576051)')
